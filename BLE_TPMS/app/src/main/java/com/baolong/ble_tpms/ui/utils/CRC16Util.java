...
public class CRC16Util {
    public static final String TAG = "CRC16Table";
...
//    char Crc16(byte[] Source, byte len) {
//
//        char crc;
//        byte da;
//        crc = 0x0;
...
////        byte Leth=10;
////        char CRC=Crc16(CrcByte,Leth);
//
//
//        return (crc);
//    }

    public static String GetCRC(byte[] bytes) {//byte[]
        int crc = 0xffff;  //初始值
        Log.i(TAG,"bytes 长度为: " + bytes.length);
        for (byte b : bytes) {
        ...
        //b[0] = (byte) (crc >> 8);
        //b[1] = (byte) (crc >> 0);
        return Integer.toHexString(getUint16(crc));
    }
