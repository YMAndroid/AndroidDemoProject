...
//    private int totalMovedLength;
    ...
    private void initData() {
        ...
        // 已完成进度条画笔的属性
        paintInit.setColor(context.getResources().getColor(R.color.background_color));
        ...
        // 大圆画笔
        paintEndBig.setColor(context.getResources().getColor(R.color.background_color));
        ...
        paintText.setColor(context.getResources().getColor(R.color.background_color));
